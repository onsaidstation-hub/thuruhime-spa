...
(function ($) {
	 ...
	 * 例）
	 * <div class="sns-btn_fb" data-url="https://web.archive.org/web/20221211143451/http://example.com/" data-title="EXAMPLE"></div>
	 */
	...
	$('.sns-btn_tw').each(function () {
		...
		$(this).append('<a target="_blank" href="https://web.archive.org/web/20221211143451/https://twitter.com/share?url=' + target_url + '&text=' + target_title + '"><i class="fa fa-twitter" aria-hidden="true"></i><span>Tweet</span></a>');
	});
	...
	$('.sns-btn_fb').each(function () {
		...
		target_url = encodeURI( target_url );
		$(this).append('<a target="_blank" href="https://web.archive.org/web/20221211143451/https://www.facebook.com/sharer/sharer.php?u=' + target_url + '"><i class="fa fa-facebook-official" aria-hidden="true"></i><span class="count_fb"></span></a>');
		$count_html = $(this).find('.count_fb');

		$.ajax({
			url     : 'https://web.archive.org/web/20221211143451/https://graph.facebook.com/',
			dataType: 'jsonp',
			data    : {
				id: target_url,
	...
	$('.sns-btn_hatena').each(function () {
		...
		$(this).append('<a target="_blank" href="https://web.archive.org/web/20221211143451/http://b.hatena.ne.jp/add?mode=confirm&url=' + target_url + '&title=' + target_title + '"><i class="f-hatena" aria-hidden="true"></i><span class="count_hatena"></span></a>');
		$count_html = $(this).find('.count_hatena');

		$.ajax({
			url     : 'https://web.archive.org/web/20221211143451/https://b.hatena.ne.jp/entry.count',
			type    : 'get',
			dataType: 'jsonp',
			data    : {
				url: target_url
	...
	$('.sns-btn_gplus').each(function () {
		...
		$(this).append('<a target="_blank" href="https://web.archive.org/web/20221211143451/https://plus.google.com/share?url=' + target_url + '"><i class="fa fa-google-plus" aria-hidden="true"></i><span>+1</span></a>');
	});
	...
	$('.sns-btn_line').each(function () {
		...
		$(this).append('<a href="https://web.archive.org/web/20221211143451/http://line.me/R/msg/text/?' + target_url + '\"><i class="icon_line"></i><span>LINEで送る</span></a>');
	});
	...
	$('.sns-btn_pocket').each(function () {
		...
		$(this).append('<a href="https://web.archive.org/web/20221211143451/http://getpocket.com/edit?url=' + target_url + '&title=' + target_title + '\" onclick="window.open(this.href, \'PCwindow\', \'width=550, height=350, menubar=no, toolbar=no, scrollbars=yes\'); return false;"><i class="fa fa-get-pocket" aria-hidden="true"></i><span>Pocket</span></a>');
	});
...
/*
     FILE ARCHIVED ON 14:34:51 Dec 11, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 20:39:39 Jul 03, 2026.
...
playback timings (ms):
  ...
  esindex: 0.013
  cdx.remote: 327.599
  LoadShardBlock: 105.617 (3)
  PetaboxLoader3.datanode: 170.961 (6)
  load_resource: 435.976 (2)
  PetaboxLoader3.resolve: 333.478 (2)
  loaddict: 52.694
*/